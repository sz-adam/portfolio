  ...
  return (
    <AnimatedMotion animationName="homeImageAnimation">
      ...
      <div className="flex flex-col">
        <div className="flex justify-center items-center pt-2 m-2">
          <img
            src={Me4}
            alt="my portfolio"
            className="w-72 sm:w-96 lg:w-64 xl:w-96 rounded-full  "
        ...
        <div className="p-3 ">
          <a
            href="https://github.com/sz-adam?tab=repositories"
