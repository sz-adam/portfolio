      ...
      <div className="z-50 fixed inset-0 flex items-center justify-center p-5 ">
        ...
        >
          <div className="w-1/2 max-md:w-full max-sm:h-[45%] max-md:h-[55%]">
            <img
              className="w-full h-full object-cover max-md:rounded-t-2xl md:rounded-l-2xl"
              src={portfolio.src}
              alt={portfolio.name}
            />
          </div>
          <div className="flex flex-col justify-center items-center text-center w-full  md:w-1/2 p-4">
            ...
            <p className="text-gray-200 my-4 md:my-10 text-justify ">
              {portfolio.title}
            </p>
            <p className="text-gray-400"># {portfolio.stack.join(" #")}</p>
            ...
            <div className="mt-10 max-sm:mt-2">
              <button
                onClick={closeModal}
                className="relative inline-flex items-center justify-center p-4 px-10 py-3 border overflow-hidden font-medium transition duration-300 ease-out rounded-full shadow-md group"
              >
