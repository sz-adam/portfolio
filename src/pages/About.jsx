      ...
      <div className="text-center p-2">
        ...
        >
          <div className="flex max-md:flex-col justify-around items-center pb-2 my-16 ">
            <Link
              to="/portfolio"
              className="relative inline-flex items-center justify-center   p-4 px-6 py-3 overflow-hidden font-medium transition duration-300 ease-out rounded-full shadow-md group"
            ...
            <a
              href={oneletrajz}
              className="md:mt-0 mt-10 relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium transition duration-300 ease-out rounded-full shadow-md group"
              style={{ boxShadow: boxShadow }}
            >
              <span className="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-cyan-700 group-hover:translate-x-0 ease">
                <AiOutlineArrowRight size={25} />
